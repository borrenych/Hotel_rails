# Controller for rooms at admin interface
class Admin::RoomsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @room.update(room_params)
        format.html { redirect_to admin_room_path, notice: 'Room was successfully updated.' }
  ...
  def admin_check
    redirect_to rooms_path, alert: 'You cant check this' unless current_user && current_user.admin?
  end
